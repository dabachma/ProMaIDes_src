...
public:
	...
	void set_curve_characteristics(const int index, const QwtText title, const QwtPlotCurve::CurveStyle style, const QColor color, const int width);
	///Set curve data
	...
	///Maybe a bug?
	void updateMyLegend(QwtLegend *legend, bool update) const;
