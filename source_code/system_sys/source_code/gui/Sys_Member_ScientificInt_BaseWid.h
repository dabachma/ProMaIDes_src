#pragma once
/**\class Sys_Member_ScientificInt_BaseWid
...
#ifndef SYS_MEMBER_SCIENTIFICINT_BASEWID_H
#define SYS_MEMBER_SCIENTIFICINT_BASEWID_H

//forms
#include "ui_Sys_Member_ScientificInt_BaseWid.h"
...
///Base-widget for displaying an interger variable as scientific with a text label \ingroup sys
/**

*/
class Sys_Member_ScientificInt_BaseWid : public QWidget, public Ui::scientificIntForm
{
...
public:
	...
	///Default Constructor
	Sys_Member_ScientificInt_BaseWid(QWidget *parent = 0);
	///Default Destructor
	~Sys_Member_ScientificInt_BaseWid(void);
