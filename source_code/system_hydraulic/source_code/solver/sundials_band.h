...
//for ilu-matrix
SUNDIALS_EXPORT int bandGBTRF_ilu(realtype **a, int mu,  int *r_id, int neq);
/*
 * -----------------------------------------------------------------
 * Function : BandGBTRS
 * -----------------------------------------------------------------
...
//Changed Daniel 22.10.2014
//for ilu-matrix
SUNDIALS_EXPORT void bandGBTRS_ilu(realtype **a, int ml, realtype *b, int *r_id, int neq);
/*
 * -----------------------------------------------------------------
 * Function : BandCopy
 * -----------------------------------------------------------------
...
SUNDIALS_EXPORT void BandCopyJ(DlsMat A, DlsMat B, int copymu, int copyml, int *r_id, int neq, realtype c);
SUNDIALS_EXPORT void bandCopyJ(realtype **a, realtype **b, int n, int a_smu, int b_smu,
                  int copymu, int copyml, int *r_id, int neq, realtype c);
//Changed Daniel 22.10.2014
//copy optimized jacobi-matrix to ilu-matrix
SUNDIALS_EXPORT void BandCopyJ_ilu(DlsMat A, DlsMat B, int copymu, int copyml,int *r_id, int neq, realtype c);
SUNDIALS_EXPORT void bandCopyJ_ilu(realtype **a, realtype **b, int n, int a_smu, int b_smu,
                  int copymu, int copyml, int *r_id, int neq, realtype c);
/*
 * -----------------------------------------------------------------
 * Function: BandScale
...
SUNDIALS_EXPORT void BandScaleJ(realtype c, DlsMat A);
SUNDIALS_EXPORT void bandScaleJ(realtype c, realtype **a, int n, int mu, int ml, int smu);
