...
int jac2CS(int n, int nx, double **a, int n_real, int *r_id, csptr bmat, double gamma){
    ...
    if (setupCS(bmat, n, 1)) {
      printf(" ERROR SETTING UP bmat IN jac2CS \n") ;
      exit(0);
    }

    //explaination for csptr
    //int n;
...
//        bmat->ja[i] = (int *) Malloc(counter_nnz_row*sizeof(int), "jac2CS:1" );
//        bmat->ma[i] = ( double *) Malloc(counter_nnz_row*sizeof( double),"jac2CS:2" );
//        bmat->nzcount[i]=counter_nnz_row;
...
//            if(i-nx>=0){
//                if(row[0]>0.0){
//                    bmat->ja[i][counter_nnz_row]=i-nx;
//                    bmat->ma[i][counter_nnz_row]=row[0]*gamma;
//                    counter_nnz_row++;
//                }
//            }
//            if(i-1>=0){
...
//                    bmat->ja[i][counter_nnz_row]=i-1;
//                    bmat->ma[i][counter_nnz_row]=row[1]*gamma;
//                    counter_nnz_row++;
//                }
//            }
//            //diagonal
//            bmat->ja[i][counter_nnz_row]=i;
//            bmat->ma[i][counter_nnz_row]=row[2]*gamma+1.0;
//            counter_nnz_row++;
//            if(i+1<n){
//                if(row[3]>0.0){

//                    bmat->ja[i][counter_nnz_row]=i+1;
//                    bmat->ma[i][counter_nnz_row]=row[3]*gamma;
//                    counter_nnz_row++;
//                }
//            }
//            if(i+nx<n){
...
//                    bmat->ja[i][counter_nnz_row]=i+nx;
//                    bmat->ma[i][counter_nnz_row]=row[4]*gamma;
//                    counter_nnz_row++;
//                }
//            }
...
//        }
    ...
    for( i=0;i<n_real;i++){
        ...
        if(id>=0){
            ...
            bmat->ja[id] = (int *) Malloc(counter_nnz_row*sizeof(int), "jac2CS:1" );
            bmat->ma[id] = ( double *) Malloc(counter_nnz_row*sizeof( double),"jac2CS:2" );
            bmat->nzcount[id]=counter_nnz_row;
        }
        ...
        if(id>=0){
            row=a[id];
                if(i-nx>=0){
                    ...
                    if(id1>=0){
                        if(row[0]>0.0){
                            bmat->ja[id][counter_nnz_row]=id1;
                            bmat->ma[id][counter_nnz_row]=row[0]*gamma;
                            counter_nnz_row++;
                        }
                    }
                }
                if(i-1>=0){
                    ...
                    if(id1>=0){
                        if(row[1]>0.0){
                            ...
                            bmat->ja[id][counter_nnz_row]=id1;
                            bmat->ma[id][counter_nnz_row]=row[1]*gamma;
                            counter_nnz_row++;
                        }
                    }
                }
                //diagonal
                bmat->ja[id][counter_nnz_row]=id;
                bmat->ma[id][counter_nnz_row]=row[2]*gamma+1.0;
                ...
                if(i+1<n_real){
                    ...
                    if(id1>=0){
                        if(row[3]>0.0){
                            ...
                            bmat->ja[id][counter_nnz_row]=id1;
                            bmat->ma[id][counter_nnz_row]=row[3]*gamma;
                            counter_nnz_row++;
                        }
                    }
                }
                if(i+nx<n_real){
                    ...
                    if(id1>=0){
                        if(row[4]>0.0){
                            ...
                            bmat->ja[id][counter_nnz_row]=id1;
                            bmat->ma[id][counter_nnz_row]=row[4]*gamma;
                            counter_nnz_row++;
                        }
                    }
                }
...
int cp_jac2CS(int n, int nx, double **a, int n_real, int *r_id, csptr bmat, double gamma){
