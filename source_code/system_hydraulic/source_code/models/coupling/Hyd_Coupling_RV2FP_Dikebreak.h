...
public:
	...
	void init_coupling(Hyd_Coupling_RV2FP_Merged *couplings, const int number, _Hyd_River_Profile **involved_profiles, const int number_involved_profiles, const int section_id_fpl);
	...
	void init_coupling(Hyd_Coupling_RV2FP_Merged *couplings, const int number, const int section_id_fpl, const int point_id);
