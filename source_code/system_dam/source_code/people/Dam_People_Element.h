...
public:
	...
	static void Dam_People_Element::select_all_relevant_elements_stream(QSqlQuery* query, QSqlDatabase* ptr_database, const _sys_system_id id, const int raster_id, const bool with_output = true);
