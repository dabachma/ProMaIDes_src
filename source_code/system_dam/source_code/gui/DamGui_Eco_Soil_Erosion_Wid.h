#pragma once
/**\class DamGui_Eco_Soil_Erosion_Wid
...
#ifndef DAMGUI_ECO_SOIL_EROSION_WID
#define DAMGUI_ECO_SOIL_EROSION_WID

//forms
#include "ui_DamGui_Eco_Soil_Erosion_Wid.h"
...
///Widget to show or edit the ecological soil-erosion function \ingroup dam
/**

\see Dam_Eco_Soil_Erosion_Function
*/
class DamGui_Eco_Soil_Erosion_Wid : public _Sys_Abstract_Base_Wid
{
...
public:
	...
	///Default constructor
	DamGui_Eco_Soil_Erosion_Wid(DataRole role = DisplayRole, QWidget *parent = 0);
	///Default destructor
	~DamGui_Eco_Soil_Erosion_Wid(void);
...
private:
	///Qt-form member
	Ui::DamGui_Eco_Soil_Erosion ui;
};

#endif //DAMGUI_ECO_SOIL_EROSION_WID
