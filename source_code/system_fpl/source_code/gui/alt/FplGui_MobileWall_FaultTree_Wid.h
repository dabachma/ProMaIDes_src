#pragma once
/**\class FplGui_MobileWall_FaultTree_Wid
...
#ifndef FPLGUI_MOBILEWALL_FAULTTREE_WID_H
#define FPLGUI_MOBILEWALL_FAULTTREE_WID_H
...
///Widget to show or edit 'MobileWall FaultTree' data
/**

*/
class FplGui_MobileWall_FaultTree_Wid : public FplGui_FaultTree_BaseWid
{
	Q_OBJECT // Qt-macro

public:
	///Default constructor
	FplGui_MobileWall_FaultTree_Wid(DataRole role = DisplayRole, QWidget *parent = 0);
	///Default destructor
	~FplGui_MobileWall_FaultTree_Wid(void);
...
#endif // FPLGUI_MOBILEWALL_FAULTTREE_WID_H
