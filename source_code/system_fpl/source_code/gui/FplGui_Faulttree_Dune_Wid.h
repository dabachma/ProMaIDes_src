#pragma once
/**\class FplGui_Faulttree_Dune_Wid
...
#ifndef FPLGUI_FAULTTREE_DUNE_WID_H
#define FPLGUI_FAULTTREE_DUNE_WID_H

//forms
#include "ui_FplGui_Faulttree_Dune_Wid.h"
...
///Widget for displaying the faulttree of the dune section type \ingroup fpl
/**

*/
class FplGui_Faulttree_Dune_Wid : public _Sys_Abstract_Base_Wid
{
...
public:
	...
	///Default constructor
	FplGui_Faulttree_Dune_Wid(DataRole role = DisplayRole, QWidget *parent = 0);
	///Default destructor
	~FplGui_Faulttree_Dune_Wid(void);
...
private:
	//member
	///Qt-form member
	Ui::FplGui_Faulttree_Dune_Wid ui;


	//method
	///Transfer members to database
	void transfer_members2database(FplGui_Faulttree_Dune_Wid *dialog);
